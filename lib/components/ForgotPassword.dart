      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            Center(
              child: Text(
                context.translator.myNotificationNewexercise,
            ...
            Text(
              context.translator.forgotPasswordResetcode,
            ...
            const SizedBox(height: 30),
            Text(
              context.translator.forgotPasswordEmail,
            ...
            InputField(
              ...
              hint: context.translator.editProfMailHint,//translator.getString("EditProf.mailHint"),
