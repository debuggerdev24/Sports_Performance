                  ...
                  child: SingleChildScrollView(
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: DataTable(
                        ...
                        columns: const [
                          DataColumn(label: MyHeader("SportNutrition.header1")),
                          DataColumn(label: MyHeader("SportNutrition.header2")),
                          DataColumn(label: MyHeader("SportNutrition.header3")),
                          DataColumn(label: MyHeader("SportNutrition.header4")),
                          DataColumn(label: MyHeader("SportNutrition.header5")),
                        ],
                        rows: List.generate(
                          data.length,
                          (i) => DataRow(
