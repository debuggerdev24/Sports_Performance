            ...
            child: Column(
              children: [
                ...
                SettingItem(
                  ...
                  title: translator.getString("Setting.changePass"),
                  onTap: () {
                    Get.toNamed(
                      '/change-password',
                    );
                ...
                SettingItem(
                  ...
                  title: translator.getString("Setting.darkMode"),
                  trailing: MySwitchButton(isDark, changeThemeMode),
                ),
                SettingItem(
                  icon: Icons.language,
                  title: translator.getString("Setting.language"),
                ...
                Text(
                  "${translator.getString("Setting.version")} 1.0.0",
