...
import '../components/bar_graphs/bar_graph.dart';
import '../main.dart';
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        children: [
                          ...
                          Text(
                            context.translator.lowerBodyPush,
                          ...
                          Text(
                            context.translator.upperBodyPush,
                            style: TextStyle(fontSize: size.width * 0.042),
                          ),
                          ...
                          Gap(size.height * 0.02),
                          Text(
                            context.translator.lowerBodyPull,
                            style: TextStyle(fontSize: size.width * 0.042),
                          ),
                          Gap(size.height * 0.01),
                          SizedBox(
                          ...
                          Gap(size.height * 0.02),
                          Text(
                            context.translator.upperBodyPull,
                            style: TextStyle(fontSize: size.width * 0.042),
                          ),
                          Gap(size.height * 0.01),
                          SizedBox(
